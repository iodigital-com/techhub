...
date: '2022-10-26'
.images: ['../images/getting-started-with-trpc/hero-part2.png']
...
import powerTRPCImage from '../images/getting-started-with-trpc/power-of-trpc.gif';
import fullAppImage from '../images/getting-started-with-trpc/full-app.gif';
...
<img src={powerTRPCImage.src} width="1200" height="1073" alt="the power of trpc" />
...
<img src={fullAppImage.src} width="600" height="1298" alt="What we are creating" />
