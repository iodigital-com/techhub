...
import renamingImage from './images/6-vscode-tips/renamingf2.gif';
import keybindingsImage from './images/6-vscode-tips/keybindings-json.gif';
import autoImportImage from './images/6-vscode-tips/autoimport.webp';
...
<Image src={renamingImage} alt="renaming" width={438} height={72} style={{ borderRadius: 8 }} />
