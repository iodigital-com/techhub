...
<div className="bg-io_beige-100 p-4">
  _The author generated this text in part with GPT-3, OpenAI’s large-scale
  ...
  ultimate responsibility for the content of this publication._
</div>

<div className="mt-4 bg-io_beige-100 p-4">
  You can create your account for GPT-3 at
  [beta.openai.com](https://beta.openai.com) and Dall-e at
...
![Content creator taking notes](../images/open-ai/the-current-state-of-ai-for-content-creators/content-creator-taking-notes.png)
...
![A device with levers](../images/open-ai/the-current-state-of-ai-for-content-creators/a-device-with-levers.png)
...
![A painter freestyle on the wall](../images/open-ai/the-current-state-of-ai-for-content-creators/a-painter-freestyle-on-the-wall.png)
...
![An abstract combination of shapes](../images/open-ai/the-current-state-of-ai-for-content-creators/an-abstract-combination-of-shapes.png)
...
![Dall-e](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle.jpeg)
...
![15mm wide-angle lens photo of a rapper in 1990 New York holding a kitten up to the camera](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle-kitten.png)

```text
a man in a business suit holding a briefcase and a cat
```

![a man in a business suit holding a briefcase and a cat](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle-man-with-cat.png)
...
![a group of people of different races and genders holding hands in front of a sun setting over a cityscape](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle-hope.png)
...
![a person floating in space with their eyes closed and a thought bubble above their head containing a image of a brain](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle-consciousness.png)

Here are some examples of cute cats and its prompts.

![a cute cat](../images/open-ai/the-current-state-of-ai-for-content-creators/dalle-cat.jpeg)
