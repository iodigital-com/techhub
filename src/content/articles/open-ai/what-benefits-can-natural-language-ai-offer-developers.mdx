...
images:
  [
    "/articles/open-ai/what-benefits-can-natural-language-ai-offer-developers/header.jpeg",
  ]
...
![Writing style translation example](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/translation-example.png)
...
![keyboard prediction](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/keyboard-prediction.png)
...
![copilot user delete](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/copilot-prediction-user-delete.png)
...
createConnection().then(async (connection) => {
  ...
  app.put("/users /:id", async (req, res) => {
    const user = await connection.manager.update(
      User,
      req.params["id"],
      req.body
    );
...
![gpt-3 precision example](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-precision-example.png)
...
![gpt-3 blog prompt](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-blog-prompt.png)

Then most importantly, I provided the AI with a blog structure.

![gpt-3 blog structure](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-blog-structure.png)

These are the playground settings that I used.

![gpt-3 playground settings](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-playground-settings.png)
...
![gpt-3 self write 1](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-self-write-1.png)

![gpt-3 self write 2](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-self-write-2.png)

![gpt-3 self write 3](../images/open-ai/what-benefits-can-natural-language-ai-offer-developers/gpt-3-self-write-3.png)
