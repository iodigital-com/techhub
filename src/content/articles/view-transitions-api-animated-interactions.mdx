...
images:
  [
    './images/view-transitions-api-animated-interactions/view-transitions-api-animated-interactions.png',
  ]
...
import removingUnanimatedImage from './images/view-transitions-api-animated-interactions/removing-unanimated.gif'
import removingAnimatedImage from './images/view-transitions-api-animated-interactions/removing-animated.gif'
import addingUnanimatedImage from './images/view-transitions-api-animated-interactions/adding-unanimated.gif'
import addingAnimatedImage from './images/view-transitions-api-animated-interactions/adding-animated.gif'
import togglingUnanimatedImage from './images/view-transitions-api-animated-interactions/toggling-unanimated.gif'
import togglingAnimatedImage from './images/view-transitions-api-animated-interactions/toggling-animated.gif'
import reorderingImage from './images/view-transitions-api-animated-interactions/reordering-animated.gif'
import tableImage from './images/view-transitions-api-animated-interactions/table-animated.gif'
...
<div className="md:-mx-32 my-4">
  <div className="relative aspect-w-16 aspect-h-9 border">
    <iframe
      src="https://codepen.io/davebitter/full/JjwgdRZ"
...
<img
  src={removingUnanimatedImage.src}
  width="1200"
  height="566"
  alt="Screen recording showing an item being removed and the grid of cards immediately snap into place"
/>
...
<img
  src={removingAnimatedImage.src}
  width="1200"
  height="568"
  alt="Screen recording showing an item being removed and the grid of cards animate into place"
/>
With just adding the `document.startViewTransition` and a unique `view-transitions-name` for each list
item, the entire grid repositioning is animated providing better feedback to the user. Awesome, right?
One of the biggest benefits I find of this approach is that the View Transitions API just takes a before
and after state. It doesn’t matter how you build your layout, what properties change or how different
the two views are. As long as before and after your change (the removal of the one list item node) items
have matching `view-transitions-name` properties, the browser will animate between them.
...
<img
  src={addingUnanimatedImage.src}
  width="1200"
  height="568"
  alt="Screen recording showing an item being added and the grid of cards immediately snap into place"
/>
...
<img
  src={addingAnimatedImage.src}
  width="1200"
  height="568"
  alt="Screen recording showing an item being added and the grid of cards animate into place"
/>
...
<img
  src={reorderingImage.src}
  width="1200"
  height="567"
  alt="Screen recording showing an items being randomly reordered and the grid of cards animate into place"
/>
...
<img
  ...
  width="1200"
  height="567"
  alt="Screen recording showing an items being reordered, removed and added and the grid of cards animate into place"
/>
...
<img
  src={togglingUnanimatedImage.src}
  width="1200"
  height="567"
  alt="Screen recording showing the grid of cards toggle between grid and table view and immediately snap into place"
/>

I thought to myself, why not use this technique when switching between the two views?

<img
  src={togglingAnimatedImage.src}
  width="1200"
  height="567"
  alt="Screen recording showing the grid of cards toggle between grid and table view and animating into place"
/>
