function AuthorReact({ author }) {

  const url = '/authors/' + author.slug + '/';

  return (
    <div className="grid grid-cols-12 my-10 bg-green-200 p-5 rounded-lg">
      <header className="col-span-5">
        <ul className="flex gap-10 items-center">
          <li className="flex gap-2 flex-col items-center">
            ...
            {/* social links */}
            <div className="my-10 flex justify-center space-x-4 mx-auto">
              {author.data.mail && <a
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 20 20"
                  class="h-6 w-6 hover:text-blue-500 dark:text-gray-500 fill-current"
                ><path
                  d="M2.003 5.884 10 9.882l7.997-3.998A2 2 0 0 0 16 4H4a2 2 0 0 0-1.997 1.884z"
                ></path><path
                  d="m18 8.118-8 4-8-4V14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8.118z"></path>
                </svg>
              </a>}
              {author.data.github && <a
              ...
              {author.data.facebook && <a
                class="h flex items-center"
                target="_blank"
                rel="noopener noreferrer"
                href={author.data.facebook}
              >
              ...
              {author.data.youtube && <a
                class="h flex items-center"
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.youtube.com/channel/UCNhy3hGzwMfbtX3Ei8Htcpg"
              >
      ...
      <article className="col-start-7 col-span-full flex gap-5 flex-col">
        ...
        <p className="text-base">{author.body}</p>
      </article>
    </div>);
}

export default AuthorReact;
